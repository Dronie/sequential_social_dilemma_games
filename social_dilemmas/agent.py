...
class Agent(object):
    def __init__(self, agent_id, start_pos, start_orientation, full_map, row_size, col_size):
        ...
        self.apples_consumed_this_turn = 0
        self.beams_fired_this_turn = 0
        self.times_hit_this_turn = 0
        self.tiles_cleaned_this_turn = 0
    ...
    def compute_apples_consumed(self):
        a_consumed = self.apples_consumed_this_turn
        self.apples_consumed_this_turn = 0
        return a_consumed

    def compute_times_hit(self):
        times_hit = self.times_hit_this_turn
        self.times_hit_this_turn = 0
        return times_hit

    def compute_beams_fired(self):
        beams_fired = self.beams_fired_this_turn
        self.beams_fired_this_turn = 0
        return beams_fired

    def compute_tiles_cleaned(self):
        tiles_cleaned = self.tiles_cleaned_this_turn
        self.tiles_cleaned_this_turn = 0
...
class HarvestAgent(Agent):
    ...
    def hit(self, char):
        if char == b"F":
            self.times_hit_this_turn += 1
            self.reward_this_turn -= 50

    def fire_beam(self, char):
        if char == b"F":
            self.beams_fired_this_turn += 1
    ...
    def consume(self, char):
        """Defines how an agent interacts with the char it is standing on"""
        if char == b"A":
            self.apples_consumed_this_turn += 1
            self.reward_this_turn += 1
            return b" "
        else:
            return char
