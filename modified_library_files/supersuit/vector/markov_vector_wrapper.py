...
class MarkovVectorEnv(gym.vector.VectorEnv):
    ...
    def step(self, actions):
        ...
        #print('supersuit_markov_vector_wrapper_infos:', infos)
        ...
        for agent, obs in observations.items():
            infos[agent]['social_welfare'] = infos['social_welfare']
            infos[agent]['apples_consumed'] = infos['apples_consumed']
            infos[agent]['beams_fired'] = infos['beams_fired']
            infos[agent]['times_hit'] = infos['times_hit']
            infos[agent]['tiles_cleaned'] = infos['tiles_cleaned']
